  ...
  ru: {
    translation: {
      ...
      profile: {
        ...
        notifications: '🔔 Уведомления', sound: '🔊 Звук сообщений',
      ...
      common: { loading: 'Загрузка...', on: 'Вкл', off: 'Выкл' },
  ...
  be: {
    translation: {
      ...
      profile: {
        ...
        notifications: '🔔 Апавяшчэнні', sound: '🔊 Гук паведамленняў',
      ...
      common: { loading: 'Загрузка...', on: 'Укл', off: 'Выкл' },
  ...
  en: {
    translation: {
      ...
      profile: {
        ...
        notifications: '🔔 Notifications', sound: '🔊 Message Sound',
      ...
      common: { loading: 'Loading...', on: 'On', off: 'Off' },
