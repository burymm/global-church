...
| # | Task | Status |
|---|------|--------|
| 5 | Task 06 initialization — finish auth + functionality checks | [backlog/docs/06-task-initialization.md](backlog/docs/06-task-initialization.md) |

## Planned (Roadmap)

### Фаза 1 — MVP
- [ ] Auth + Map + Chat + Profile (done)
- [ ] Finish initialization checks (checklist in [06-task-initialization.md](backlog/docs/06-task-initialization.md))
